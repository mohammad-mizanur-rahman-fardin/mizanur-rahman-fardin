...
export const skillCategories: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Laravel Migrations", iconName: "DatabaseIcon", colorClass: "hover:text-[#FF2D20] hover:shadow-[#FF2D20]/20" },
      { name: "Laravel Seeders", iconName: "DatabaseIcon", colorClass: "hover:text-[#FF2D20] hover:shadow-[#FF2D20]/20" },
